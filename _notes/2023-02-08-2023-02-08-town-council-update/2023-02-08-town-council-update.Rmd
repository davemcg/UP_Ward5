...
The members of the Began discussing how to best order the list of stormwater handling suggestions. You can find a copy of the report [here](https://www.upmd.org/AgendaCenter/ViewFile/Agenda/_12192022-715) within the agenda. Currently the aim is for each councilmember to independently order the projects. We have approximately 1.2 million left from the ARPA funds (I think). The projects within this report total about 3 million. 
