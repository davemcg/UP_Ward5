...
3. The full remaining sum of the American Rescue Plan "free federal money" (~1.875M) has been declared in the budget to by spent this year. I'm a bit concerned that we won't be able to put all this money into a signed contract without a town administrator. 
...
Some line by line comments:
  ...
  - Path lights in the park is, in my mind, dead. The Mayor perhaps thought this was such a slam dunk idea that no one needed to be consulted about it. Several residents have reached out to complain about the deleterious effects of light pollution, council noted that there were zero crime reports in the park after dark, and Mayor Carey pointed out that in 2012 (yes 2012) he was told path lights would cost around \$300,000. 
...
The Mayor has proposed a real tax cut (as in your taxes to UP would be lower than the previous year, in real dollars). This is mostly from eliminating the town administrator position. I would except that taxes will be kept on the "constant yield" and be about the same as last year after we are done with the budget. While the Mayor proposes a budget, the council is in responsible for passing it. We will edit any areas of concern.
...
Extra police enforcement on morning “do not enters” from Baltimore avenue (Wells -> Sheridan). caught 8 illegal entries

The morning school crossing guard reported several illegal entries each week onto Underwood (which is one way this time of day). Mr. Beall installed a 2nd do not enter sign at the intersection of Underwood and Queens Chapel, which seem to be helping.
...
Attorney Ferguson reports that we should hear news soon on getting control of the town streetlights from Pepco. This would allow us, in theory, to install LED lights to reduce light pollution and energy costs. 
