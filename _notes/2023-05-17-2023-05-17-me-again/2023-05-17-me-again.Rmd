...
6. 28k for composting bins ([see below](#-Composting-Bins-and-Bags))
...
The council supported my proposal to fund the "Nixle" emergency alert system. This will enable the Police department to directly send out text/email alerts. Including emergency alerts for now-problems (like our recent mini burglary spree and assault of a resident on Baltimore Ave). The Chief is still working with the vendor to iron out some implementation details. I also urged the council/Mayor to send out a physical flyer asking everyone to sign up for this service. There will be several levels of alerts so you have some control over what kind of alerts you would like to receive (town events / local alerts / urgent notices).
